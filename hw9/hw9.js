...
for (const simpson of simpsons) {
    ...
    div5.classList.add('member');

    let h2 = document.createElement('h2');
    h2.innerHTML = `<b>Name</b>: ${simpson.name}, <b>Surname:</b> ${simpson.surname}`;

    let h3 = document.createElement('h3');
    h3.innerHTML = `<b>Age</b>: ${simpson.age}`;

    let p = document.createElement('p');
    p.innerHTML = `<b>Info</b>: ${simpson.info}`;

    let div6 = document.createElement('div');
    div6.classList.add('photo');
...
for (const course of coursesArray) {
    let courseD = document.createElement('div');
    courseD.classList.add('course');
    courseD.style.display = 'flex';

    let titleD = document.createElement('div');
    titleD.classList.add('title');
    titleD.innerText = `Title: ${course.title}`;

    let durationD = document.createElement('div');
    durationD.classList.add('duration');
    durationD.innerText = `Duration: ${course.monthDuration} months`;
    durationD.style.width = '30%';

    let modulesD = document.createElement('div');
    modulesD.classList.add('modules');
    let modulesL = document.createElement('ul');
